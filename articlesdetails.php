...
<div class="container" style="background-color: #f8fbfd;">
    ...
    <h4> Les articles juridiques <a class="btn btn-light" href="index.php" role="button">Retour à l'acceuil</a></h4>
        ...
        <table id="mytable" class="table table-hover">
            <thead>
                <tr>
                    ...
                    <th scope="col"> Voir les version</th>
            ...
            <tbody>
                ...
                <td>' . $row[6] . '</td>
                  <td><a href="tline.php?idarticle=' . $row[0] . '">voir les versions</a></td>
